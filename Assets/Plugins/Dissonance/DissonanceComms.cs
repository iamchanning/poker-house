...
namespace Dissonance
{
    ...
    /// </remarks>
    public class DissonanceComms : MonoBehaviour, IPriorityManager, IAccessTokenCollection
    {
        #region fields
        ...
        public DissonanceComms()
        {
            ...
            _rooms = new Rooms();
            _playerChannels = new PlayerChannels();
            _roomChannels = new RoomChannels();
